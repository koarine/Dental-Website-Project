            ...
            <div id="lower">
                <div id="box">
                    <table border="1" id="table">
                        <tr><td>USER MANAGEMENT TABLE</td>
                        <td colspan=2><input type="checkbox" id="patientc" onchange =cpatient() checked>Show Patients</td>
                        <td colspan=2><input type="checkbox" id="doctorc" onchange =cdoctor() checked>Show Doctors</td>
                        <td colspan=2><input type="checkbox" id="adminc" onchange =cadmin() checked>Show Admins</td><tr>
                        <script>
                            function cpatient(){
                                var items = document.getElementsByClassName("patient");
                                var boolc=!document.getElementById("patientc").checked
                                for (var i = 0; i < items.length; i++) {
                                    items[i].hidden = boolc
                                }
                            }
                            function cdoctor(){
                                var items = document.getElementsByClassName("doctor");
                                var boolc=!document.getElementById("doctorc").checked
                                for (var i = 0; i < items.length; i++) {
                                    items[i].hidden = boolc
                                }
                            }
                            function cadmin(){
                                var items = document.getElementsByClassName("admin");
                                var boolc=!document.getElementById("adminc").checked
                                for (var i = 0; i < items.length; i++) {
                                    items[i].hidden = boolc
                                }
                            }
