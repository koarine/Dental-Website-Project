<?php
    session_start();
    if (!isset($_SESSION['user_type']) || !($_SESSION['user_type'] == 'patient' || $_SESSION['user_type'] == 'doctor')) {
            ...
            <div id="box">
                <table>
                    ...
                    <form action="confirm_booking.php" method="POST" onsubmit="return validation()">
                        ...
                        ?>  
                        <tr><td class="heading2">Clinic Location:</td></tr><tr><td><select id="clinic" class ="input" name ="clinic"style ="width:285px; appearance:none;" onchange = "time_update()" required><option value ="Jurong East Clinic" <?php echo ($clinic == 1 ) ? 'selected' : ''; ?>>Jurong East Clinic</option><option value ="Bishan Clinic" <?php echo ($clinic == 2 ) ? 'selected' : ''; ?>>Bishan Clinic</option></select></td></tr>
                        ...
                        <?php 
                            ...
                            while($row = $stmt ->fetch_assoc()){
                                echo "<option value='".$row['user_id']."' id='".$row['user_id']."' class='".$row['clinic']."' ".($dr_id == $row['user_id'] ? 'selected' : '').">".$row['doctor_name']."</option>";
                            }
                        ?>  
                        <script>
                        ...
                        <tr><td class="heading2">Type of consult</td></tr><tr><td><select id="clinic" class ="input" name ="ctype"style ="width:285px; appearance:none;" required>
                            <option value ="Scaling & Polishing " <?php echo ($ctype =="Scaling & Polishing "  ) ? 'selected' : ''; ?>>Scaling & Polishing</option>
                            <option value ="Teeth Whitening" <?php echo ($ctype =="Teeth Whitening") ? 'selected' : ''; ?>>Teeth Whitening</option>
                            <option value ="Metal Braces" <?php echo ($ctype =="Metal Braces") ? 'selected' : ''; ?>>Metal Braces</option>
                            <option value ="Ceramic Braces" <?php echo ($ctype =="Ceramic Braces") ? 'selected' : ''; ?>>Ceramic Braces</option>
