...
<html lang="en">
    <head>
        ...
        <title>Radiant Smiles Dental | Registeration</title>
        <style>
            html{
                height:100%;
                min-height: 1080x;
        ...
        <div id="lower">
            <div id="box">
                <table border="0" id="table">
                    <form method="post" onsubmit="return validation()" action="php/registration_validation.php">
                        <tr style="height: 70px;">
                            <td class="boxtitle">Registration</td>
                        </tr>
                        <tr>
